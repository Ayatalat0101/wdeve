...
const ProjectspagePage = () => {
  ...
  return (
    <>
      <div className="bg-black_900 flex flex-col font-gopher items-center justify-end mx-auto w-full">
        <Header className="flex flex-col items-center justify-center md:px-5 w-full" />
        <div className="flex flex-col mt-[22px] md:px-5 relative w-full">
          <div className="h-[1365px] md:h-[871px] mx-auto w-full">
            <div className="absolute h-[1200px] md:h-[871px] inset-x-[0] mx-auto top-[0] w-full">
              <Img
                src="images/img_rectangle5370_822x1435.png"
                className="absolute h-[822px] inset-x-[0] mx-auto object-cover top-[0] w-full"
                alt="rectangle5370"
              />
              <div className="absolute bg-pink_A400_a3 bottom-[0] flex flex-col gap-[50px] h-[874px] md:h-auto inset-x-[0] items-center justify-start mx-auto p-[102px] md:px-10 sm:px-5 rounded-[50%] w-[874px]">
                <Text
                ...
                <div className="flex flex-col font-opensans gap-1.5 items-end justify-start mb-[341px] w-[2%] md:w-full">
                  <Text
              ...
              <Img
                src="images/img_ellipse6_16.png"
                className="absolute h-[196px] left-[0] object-cover top-[1%] w-[6%]"
                alt="ellipseSix"
              />
              <Img
                src="images/img_ellipse7_5.png"
                className="absolute bottom-[24%] h-[339px] object-cover right-[0] w-[12%]"
                alt="ellipseSeven"
              />
            </div>
            <Img
              src="images/img_rectangle5384_609x1439.png"
        ...
        <div className="font-opensans h-[2283px] mt-[151px] md:px-5 relative w-full">
          <div className="flex flex-col md:gap-10 gap-16 items-center justify-start mb-[-0.24px] mx-auto self-stretch w-auto z-[1]">
            <Text
