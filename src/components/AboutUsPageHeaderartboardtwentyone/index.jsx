...
const AboutUsPageHeaderartboardtwentyone = (props) => {
    ...
    <>
      <header className={props.className}>
        <div className="bg-black_900 flex md:flex-col flex-row md:gap-10 gap-[60px] items-center justify-center p-[19px] w-full">
          ...
          <div className="flex md:flex-1 md:flex-col flex-row md:gap-10 gap-[70px] items-center justify-start self-stretch w-auto md:w-full">
            ...
            <div className="flex items-center justify-start px-0.5 w-[7%] md:w-full">
            ...
            <div className="flex items-center justify-start w-[7%] md:w-full">
              <div className="flex items-center justify-start w-full">
                <Text
                  className="font-medium font-montserrat text-center text-white_A700 uppercase w-auto"
                  variant="body8"
            ...
            <div className="flex items-center justify-start px-[7px] w-[7%] md:w-full">
              <div className="flex flex-col items-center justify-start w-[99%] md:w-full">
                <Text
                  className="font-bold font-montserrat text-center text-pink_A400 uppercase w-auto"
                  variant="body8"
                >
                  ABOUT
                </Text>
...
AboutUsPageHeaderartboardtwentyone.defaultProps = {};

export default AboutUsPageHeaderartboardtwentyone;
